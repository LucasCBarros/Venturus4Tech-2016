...
// WiFi
char ssid[] = "Workshop";   // Nome da rede WiFi
char pass[] = "vnt@tws#";   // Senha
...
const char topico[] = "v4tech/vntpejr/iot";

// MOSQUITTO MQTT server: IP 37.187.106.16
IPAddress mqttServer(37, 187, 106, 16);
...
void conectaMqtt() {
  while (!mqttClient.connected()) {
    ...
    if (mqttClient.connect("v4tech_vntpejr")) {
